...
function kbe_taxonomies() {
    ...
    $labels = array(
        'name'              => 	__( KBE_PLUGIN_TITLE. ' Category', 'kbe'),
        'singular_name'     => 	__( KBE_PLUGIN_TITLE. ' Category', 'kbe' ),
        'search_items'      => 	__( 'Search '.KBE_PLUGIN_TITLE.' Category', 'kbe' ),
        'all_items'         => 	__( 'All '.KBE_PLUGIN_TITLE.' Categories', 'kbe' ),
        'parent_item'       => 	__( 'Parent '.KBE_PLUGIN_TITLE.' Category', 'kbe' ),
        'parent_item_colon' => 	__( 'Parent '.KBE_PLUGIN_TITLE.' Category:', 'kbe' ),
        'edit_item'         => 	__( 'Edit '.KBE_PLUGIN_TITLE.' Category', 'kbe' ),
    ...
    register_taxonomy( 'kbe_taxonomy', array( 'kbe_knowledgebase' ), array(
        'hierarchical'      => 	true,
        "labels"            => 	$labels,
        "singular_label"    => 	__( KBE_PLUGIN_TITLE . ' Category', 'kbe'),
        'show_ui'           => 	true,
        'query_var'         => 	true,
