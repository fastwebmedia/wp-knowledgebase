...
function wp_kbe_hooks() {
    ...
    $kbe_pageQry = $wpdb->get_results( $kbe_pageSql , OBJECT );
    $kbe_pageNum = sizeof($kbe_pageQry);
    ...
    $kbe_optSlugQry = $wpdb->get_results( $kbe_optSlugSql , OBJECT );
    $kbe_optSlugNum = sizeof($kbe_optSlugQry);
    ...
    $kbe_optPageQry = $wpdb->get_results( $kbe_optPageSql , OBJECT );
    $kbe_optPageNum = sizeof($kbe_optPageQry);
...
function kbe_breadcrumbs(){
    ...
    if(strpos($url, 'support-category') || strpos($url, 'kbe_taxonomy')){
    ...
    <?php
    }elseif(strpos($url, 'kbe_tags') || strpos($url, 'support-tags')){
